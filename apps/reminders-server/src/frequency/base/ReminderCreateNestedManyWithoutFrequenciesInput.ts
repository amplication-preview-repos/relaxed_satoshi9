...
@InputType()
class ReminderCreateNestedManyWithoutFrequenciesInput {
...
export { ReminderCreateNestedManyWithoutFrequenciesInput as ReminderCreateNestedManyWithoutFrequenciesInput };
