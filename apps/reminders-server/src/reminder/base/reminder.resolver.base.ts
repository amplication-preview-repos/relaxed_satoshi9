...
import { Frequency } from "../../frequency/base/Frequency";
...
export class ReminderResolverBase {
  ...
  @graphql.ResolveField(() => Frequency, {
    nullable: true,
    name: "frequency",
  })
  async getFrequency(
    ...
    const result = await this.service.getFrequency(parent.id);
